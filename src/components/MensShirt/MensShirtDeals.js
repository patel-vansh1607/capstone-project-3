...
const LaptopDeals = () => {
  return (
    <div className="title">
    <h2 className="sui1" >Mens Shirt Deals</h2>
    <p  className="sui2">Discover the latest mens shirt deals with exclusive discounts and offers. Shop now to save big on top brands!</p>
    <div className="deals-container">
      {phones.map((phone) => (
        <Link to={`/shirts/${phone.id}`} key={phone.id} className="phone-card">
