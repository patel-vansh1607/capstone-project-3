...
import phones from "../../data/mensshoesdata";
import "../../styles/MobileDeals.css";

const LaptopDeals = () => {
  return (
    <div className="title">
    <h2 className="sui1" >Men Shoes Deals</h2>
    <p  className="sui2">Discover the latest men shoes deals with exclusive discounts and offers. Shop now to save big on top brands!</p>
