...
const LaptopDeals = () => {
  return (
    <div className="title">
    <h2 className="sui1" >Refrigerator Deals</h2>
    <p  className="sui2">Discover the latest refrigerator deals with exclusive discounts and offers. Shop now to save big on top brands!</p>
    <div className="deals-container">
      {phones.map((phone) => (
        <Link to={`/refrigerators/${phone.id}`} key={phone.id} className="phone-card">
