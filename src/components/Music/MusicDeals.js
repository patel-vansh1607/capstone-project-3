...
import phones from "../../data/musicdata";
import "../../styles/MobileDeals.css";

const LaptopDeals = () => {
  return (
    <div className="title">
    <h2 className="sui1" >Music Deals</h2>
    <p  className="sui2">Discover the latest music deals with exclusive discounts and offers. Shop now to save big on top brands!</p>
    <div className="deals-container">
      {phones.map((phone) => (
        <Link to={`/music/${phone.id}`} key={phone.id} className="phone-card">
