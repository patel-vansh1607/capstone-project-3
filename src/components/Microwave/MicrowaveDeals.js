...
import phones from "../../data/microwavedata";
import "../../styles/MobileDeals.css";

const LaptopDeals = () => {
  return (
    <div className="title">
    <h2 className="sui1" >Microwave Deals</h2>
    <p  className="sui2">Discover the latest microwave deals with exclusive discounts and offers. Shop now to save big on top brands!</p>
