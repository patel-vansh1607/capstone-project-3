...
const LaptopDeals = () => {
  return (
    <div className="title">
    <h2 className="sui1" >Kids Footwear Deals</h2>
    <p  className="sui2">Discover the latest kids footwear deals with exclusive discounts and offers. Shop now to save big on top brands!</p>
