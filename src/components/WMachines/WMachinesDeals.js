...
import phones from "../../data/wmachinesdata";
import "../../styles/MobileDeals.css";

const LaptopDeals = () => {
  return (
    <div className="title">
    <h2 className="sui1" >Washing Machines Deals</h2>
    <p  className="sui2">Discover the latest washing machines deals with exclusive discounts and offers. Shop now to save big on top brands!</p>
    <div className="deals-container">
      {phones.map((phone) => (
        <Link to={`/washing-machines/${phone.id}`} key={phone.id} className="phone-card">
