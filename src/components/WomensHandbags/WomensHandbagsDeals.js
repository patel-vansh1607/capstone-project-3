...
import phones from "../../data/womenshandbagsdata";
import "../../styles/MobileDeals.css";

const LaptopDeals = () => {
  return (
    <div className="title">
    <h2 className="sui1" >Women Handbags Deals</h2>
    <p  className="sui2">Discover the latest women dresses deals with exclusive discounts and offers. Shop now to save big on top brands!</p>
    <div className="deals-container">
      {phones.map((phone) => (
        <Link to={`/handbags/${phone.id}`} key={phone.id} className="phone-card">
